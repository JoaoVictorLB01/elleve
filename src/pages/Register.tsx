    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-16">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold mb-2">Comece sua jornada</h1>
        ...
        <div className="border border-border rounded-2xl bg-card p-6 space-y-5">
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input id="name" placeholder="Seu nome" className="pl-10 h-11 rounded-xl" />
            </div>
          </div>
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input id="email" type="email" placeholder="seu@email.com" className="pl-10 h-11 rounded-xl" />
            </div>
          </div>
          <div>
          ...
          <Button variant="cosmic" className="w-full h-11" size="lg">
            Criar Conta
          </Button>
