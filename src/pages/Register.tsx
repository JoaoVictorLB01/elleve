    ...
    <div className="min-h-screen flex items-center justify-center px-6 sm:px-6 pt-20 sm:pt-16 pb-10">
      ...
      >
        <div className="text-center mb-8 sm:mb-8">
          ...
          <h1 className="text-[1.5rem] sm:text-2xl font-bold mb-2 sm:mb-2">{t("register.title")}</h1>
          <p className="text-sm sm:text-sm text-muted-foreground">{t("register.subtitle")}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="border border-border rounded-2xl bg-card p-6 sm:p-6 space-y-5 sm:space-y-5">
          <div>
            ...
            <div className="relative mt-2">
              ...
              <Input id="name" placeholder={t("register.namePlaceholder")} value={name} onChange={(e) => setName(e.target.value)} className="pl-10 h-12 rounded-xl text-base sm:text-sm" required />
            </div>
          </div>
          <div>
