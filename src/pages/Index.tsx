        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <motion.div {...fadeUp}>
            <motion.div
              ...
              className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full border border-border bg-muted/40 backdrop-blur-sm"
            >
            ...
            <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-[1.05] tracking-tight">
              Eleve sua
              <br />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button variant="cosmic" size="lg" className="min-w-[200px]" asChild>
                <Link to="/cursos">
                  Explorar Cursos
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" className="min-w-[200px] border-border/60" asChild>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="font-display text-3xl md:text-5xl font-bold mb-5 text-primary-foreground leading-tight">
                Pronto para sua
                <br />
                transformação?
              </h2>
              ...
              <Button variant="gold" size="lg" className="min-w-[220px]" asChild>
                <Link to="/cadastro">
                  Começar Agora
