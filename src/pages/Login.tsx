    ...
    <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 pt-14 sm:pt-16 pb-8">
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold mb-1.5 sm:mb-2">Bem-vindo de volta</h1>
          <p className="text-[13px] sm:text-sm text-muted-foreground">Entre na sua conta Elleve</p>
        </div>
