...
const LessonPlayer = () => {
  ...
  return (
    <div className="min-h-screen pt-16 flex">
      {/* Sidebar */}
      <aside
        className={`fixed lg:sticky top-16 left-0 z-40 h-[calc(100vh-4rem)] w-[320px] border-r border-border bg-card/95 backdrop-blur-xl overflow-y-auto transition-transform duration-300 ${
              ...
              {mod.lessons.map((lesson) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[11px] shrink-0 opacity-60">{lesson.duration}</span>
                  </Link>
                );
              })}
            </div>
      ...
      <div className="flex-1 min-w-0">
        {/* Toggle bar */}
        <div className="sticky top-16 z-20 flex items-center gap-3 px-4 py-3 border-b border-border bg-background/90 backdrop-blur-xl">
          <button
        ...
        <div className="max-w-3xl mx-auto p-6 md:p-10">
          <h1 className="font-display text-2xl md:text-3xl font-bold mb-6">{currentLesson.title}</h1>
          ...
          <div className="rounded-2xl border border-border bg-card p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-semibold text-sm">Texto Complementar</h3>
            </div>
